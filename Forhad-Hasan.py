...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://chat.whatsapp.com/Ic9jpW6Sd1rLaVCcxCRH6A)
        pass
    elif select =='F':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100079039863929/')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
...
def cutter():
    ...
    print(" ")
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +Forhad)
    os.system('sort -r '+ssb+' | uniq > '+Forhad)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + ssb )
    print("New File Saved:" + Forhad )
    print(47*'-')
    input(f"{S} Press Enter To Back Forhad telegram channel name Tech_32 Menu ")
    SSB(allkey)       
